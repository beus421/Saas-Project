    ...
    <section className="py-24 bg-white">
      <div className="container">
        <div className="section-heading">
          ...
          <p className="section-subtitle mt-5">Free forever. Upgrade for limited tasks, better security, and exclusive features</p>
        </div>
              ...
              <div className="flex justify-between">
                ...
                {popular === true && (
                  <div className="text-sm inline-flex px-4 py-1.5 rounded-xl border border-white/20">
                    <motion.span className="bg-[linear-gradient(to_right,#dd7ddf,#e1cd86,#bbcb92,#71c2ef,#3bffff,#dd7ddf,#e1cd86,#bbcb92,#71c2ef,#3bffff)] [background-size:200%] text-transparent bg-clip-text font-medium" animate={{backgroundPositionX: '-100%'}} transition={{duration: 1.5, ease: "linear", repeat: Infinity, repeatType: 'loop'}}>Popular</motion.span>
                  </div>
                )}
              </div>
